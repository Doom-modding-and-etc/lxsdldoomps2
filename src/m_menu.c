...
//printf("**** bleeeep\n");
	...
	for (i = 0 ; i < load_end ; i++)
	{
        ...
        //handle = fopen(name, "rb");     // ptek : fopen may be overridden by romfs. Using fioOpen instead
printf("handle = fioOpen(name, O_RDONLY);\n");
        ...
        fioRead (handle, &savegamestrings[i], SAVESTRINGSIZE);      // ptek
		//close (handle);
...
setup_menu_t keys_settings3[] =  // Key Binding screen strings       
{
    ...
    {"NEXT"    ,S_KEY       ,m_scrn,KB_X,KB_Y+11*8,&key_weaponnext  ,0,0,0,0,0,0},      // ptek : added
    {"PREVIOUS",S_KEY       ,m_scrn,KB_X,KB_Y+12*8,&key_weaponprevious  ,0,0,0,0,0,0},      // ptek : added
    {"FIRE"    ,S_KEY       ,m_scrn,KB_X,KB_Y+13*8,&key_fire        ,&mousebfire,&joybfire,0,0,0,0},
...
setup_menu_t helpstrings[] =  // HELP screen strings       
{
    ...
    {"NEXT"        ,(S_SKIP|S_KEY),m_null,KT_X3,KT_Y1+11*8,&key_weaponnext  ,0,0,0,0,0,0},      /* ptek : added */
    {"PREVIOUS"    ,(S_SKIP|S_KEY),m_null,KT_X3,KT_Y1+12*8,&key_weaponprevious  ,0,0,0,0,0,0},      /* ptek : added */
	{"FIRE"        ,(S_SKIP|S_KEY),m_null,KT_X3,KT_Y1+13*8,&key_fire        ,&mousebfire,&joybfire,0,0,0,0},
